...
public class API : IAPI
{
    ...
    public async Task<T> GET_CreateMeetingAsync<T>(
    ...
    public async Task<T> POST_CreateMeetingAsync<T>(
        CreateMeetingRequest request,
        CancellationToken cancellationToken = default
    )
        where T : CreateMeetingResponse
    {
        ...
        // Send the API request and return the response
        return await PostResponseAsync<T>("create", parameters, cancellationToken);
    }
    #endregion
    ...
    public async Task<T> GET_JoinMeetingAsync<T>(
    ...
    public async Task<T> GET_EndMeetingAsync<T>(
    ...
    public async Task<T> POST_EndMeetingAsync<T>(
        EndMeetingRequest request,
        CancellationToken cancellationToken = default
    )
        where T : EndMeetingResponse
    {
        ...
        // Send the API request and return the response
        return await PostResponseAsync<T>("end", parameters, cancellationToken);
    }
    ...
    /// <returns>The response from the API.</returns>
    /// <exception cref="ArgumentException">If the MeetingID is null or whitespace.</exception>
    public async Task<T> GET_IsMeetingRunningAsync<T>(
    ...
    public async Task<T> POST_IsMeetingRunningAsync<T>(
        IsMeetingRunningRequest request,
        CancellationToken cancellationToken = default
    )
        where T : IsMeetingRunningResponse
    {
        ...
        // Send the API request and return the response
        return await PostResponseAsync<T>("isMeetingRunning", parameters, cancellationToken);
    }
    #endregion
    ...
    /// <param name="cancellationToken">A cancellation token that can be used to cancel the operation.</param>
    /// <returns>The response from the API.</returns>
    public async Task<T> GET_GetMeetingsAsync<T>(CancellationToken cancellationToken = default)
    ...
    public async Task<T> POST_GetMeetingsAsync<T>(CancellationToken cancellationToken = default)
        where T : GetMeetingsResponse
    {
    ...
    /// <returns>The response from the API.</returns>
    /// <exception cref="ArgumentException">If the MeetingID is null or whitespace.</exception>
    public async Task<T> GET_GetMeetingInfoAsync<T>(
    ...
    public async Task<T> POST_GetMeetingInfoAsync<T>(
        GetMeetingInfoRequest request,
        CancellationToken cancellationToken = default
    )
        where T : GetMeetingInfoResponse
    {
        ...
        // Send the API request and return the response
        return await PostResponseAsync<T>("getMeetingInfo", parameters, cancellationToken);
    }
    ...
    public async Task<T> GET_GetRecordingsAsync<T>(
    ...
    public async Task<T> GET_PublishRecordingsAsync<T>(
    ...
    public async Task<T> GET_DeleteRecordingsAsync<T>(
    ...
    public async Task<T> GET_UpdateRecordingsAsync<T>(
    ...
    public async Task<T> POST_UpdateRecordingsAsync<T>(
        UpdateRecordingsRequest request,
        CancellationToken cancellationToken = default
    )
        where T : UpdateRecordingsResponse
    {
        ...
        // Send the API request and return the response
        return await PostResponseAsync<T>("updateRecordings", parameters, cancellationToken);
    }
    #endregion
    ...
    /// <returns>The response from the API.</returns>
    /// <exception cref="ArgumentException">If the RecordID is null or whitespace.</exception>
    public async Task<T> GET_GetRecordingTextTracksAsync<T>(
    ...
    public async Task<T> POST_GetRecordingTextTracksAsync<T>(
        GetRecordingTextTracksRequest request,
        CancellationToken cancellationToken = default
    )
        where T : GetRecordingTextTracksResponse
    {
        ...
        // Send the API request and return the response
        return await PostResponseAsync<T>("getRecordingTextTracks", parameters, cancellationToken);
    }
    #endregion
    ...
    /// <summary>
    /// Asynchronously sends a POST request to the BigBlueButton API and parses the response into a specific type.
    /// </summary>
    /// <typeparam name="T">The type of the response to parse.</typeparam>
    /// <param name="apiCallName">The name of the API call.</param>
    /// <param name="parameters">The parameters for the API call.</param>
        ...
        where T : BaseResponse
    {
        ...
        // Send a POST request to the BigBlueButton API and get the response
        ...
        where T : BaseResponse
    {
        ...
        {
            throw new HttpRequestException($"Error sending GET request to {url}", ex);
        }
        catch (JsonSerializationException ex)
        {
            throw new JsonSerializationException(
                $"Error deserializing JSON response from {url}",
                ex
            );
        }
        catch (JsonReaderException ex)
        {
            throw new JsonReaderException($"Error reading JSON response from {url}", ex);
        }
    }
        ...
        where T : BaseResponse
    {
        ...
        using (var data = new ByteArrayContent(formDataBytes))
        {
            ...
            {
                throw new HttpRequestException($"Error sending POST request to {url}", ex);
            }
            catch (JsonSerializationException ex)
            {
                throw new JsonSerializationException(
